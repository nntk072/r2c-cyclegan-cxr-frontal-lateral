...
def get_values(method, args, epochs):
    ...
    for ep in range(0, epochs):
        ...
        # ssim_A2B = np.load(
        #     f'output/{method}/plot_data/training/ssim_A2B_value_list_1.npy')
        # psnr_A2B = np.load(
        #     f'output/{method}/plot_data/training/psnr_A2B_value_list_1.npy')
        # ssim_B2A = np.load(
        #     f'output/{method}/plot_data/training/ssim_B2A_value_list_1.npy')
        # psnr_B2A = np.load(
        #     f'output/{method}/plot_data/training/psnr_B2A_value_list_1.npy')
        iterations = np.load(
    ...
    for ep in range(0, epochs):  # the name of the folder is validation
        ...
        # ssim_A2B = np.load(
        #     f'output/{method}/plot_data/validation/ssim_A2B_value_list_1.npy')
        # psnr_A2B = np.load(
        #     f'output/{method}/plot_data/validation/psnr_A2B_value_list_1.npy')
        # ssim_B2A = np.load(
        #     f'output/{method}/plot_data/validation/ssim_B2A_value_list_1.npy')
        # psnr_B2A = np.load(
        #     f'output/{method}/plot_data/validation/psnr_B2A_value_list_1.npy')
        iterations = np.load(
