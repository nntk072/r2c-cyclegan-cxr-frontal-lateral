...
def get_values(method, args, epochs):
    ...
    highest_ssim_A2B_index_valid = np.where(ssim_A2B_list_valid == highest_ssim_A2B_valid)
    highest_psnr_A2B_index_valid = np.where(psnr_A2B_list_valid == highest_psnr_A2B_valid)
    highest_ssim_B2A_index_valid = np.where(ssim_B2A_list_valid == highest_ssim_B2A_valid)
    highest_psnr_B2A_index_valid = np.where(psnr_B2A_list_valid == highest_psnr_B2A_valid)
